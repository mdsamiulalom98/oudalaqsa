...
class FrontendController extends Controller
{
    public function index(){
        ...
        $homeproducts = Category::where(['front_view' => 1, 'status' => 1])
            ...
            // return $homeproducts;
        return view('frontEnd.layouts.pages.index', compact('sliders','frontcategory','hotdeal_top','hotdeal_bottom', 'homeproducts'));
    }
    ...
    public function subcategory($slug, Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.subcategory', compact('subcategory','products', 'impproducts'));
    }
    ...
    public function allproducts(Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.allproducts', compact('products', 'impproducts'));
    }
    ...
    public function products($slug, Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.childcategory', compact('childcategory','products', 'impproducts'));
    }
    ...
    public function details($slug){
        ...
        $products = Product::where(['category_id' => $details->category_id, 'status' => 1])
            ...
            ->select('id', 'name', 'slug', 'new_price', 'old_price')
            ->get();
        $impproducts = Product::where(['status' => 1])
            ->with('image')
            ->limit(6)
            ->select('id', 'name', 'slug')
            ->get();
        ...
        return view('frontEnd.layouts.pages.details', compact('details', 'products','shippingcharge','impproducts','productcolors','productsizes'));
    }
