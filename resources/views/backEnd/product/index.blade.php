                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="action2-btn">
                            ...
                            <li><a href="{{route('products.update_feature',['status'=>1])}}" class="btn rounded-pill btn-info feature_update"><i class="fe-thumbs-up"></i> Feature</a></li>
                            <li><a href="{{route('products.update_feature',['status'=>0])}}" class="btn  rounded-pill btn-danger feature_update"><i class="fe-thumbs-down"></i> Feature</a></li>
