                    ...
                    <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" rows="6" class="summernote form-control @error('meta_description') is-invalid @enderror"></textarea>
                        ...
                        <!--        <input type="checkbox" class="form-check-input" value="1" id="topsale" name="topsale" />-->
                        <!--        <label class="form-check-label" for="topsale">Hot Deals</label>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <!--<div class="col-sm-3">-->
                        <!--    <div class="form-check">-->
                        <!--        <input type="checkbox" class="form-check-input" value="1" id="feature_product" name="feature_product" />-->
                        <!--        <label class="form-check-label" for="feature_product">Feture Product</label>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <!-- col end -->
