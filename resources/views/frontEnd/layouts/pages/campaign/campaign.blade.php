...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="campaign_content">
                        ...
                        <div class="comapaign_text">
                            ...
                            <a href="#order_form" class="cam_order_now" id="cam_order_now">Order Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="cam_discount">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="cam_price"><del>৳ {{$product->old_price}}</del> ৳ {{$product->new_price}}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="campaign_offer">তাই অফার শেষ হওয়ার আগেই অর্ডার করুন</h2>
                </div>
            </div>
                ...
                <div class="checkout-shipping" id="order_form">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="potro_font">কাস্টমার ইনফরমেশন</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" minlength="11" id="number" maxlength="11" pattern="0[0-9]+" title="please enter number only and 0 must first character" title="Please enter an 11-digit number." id="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{old('phone')}}" placeholder="+৮৮ বাদে ১১ সংখ্যা "  required>
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
            ...
            <div class="col-sm-7 cust-order-1">
                <div class="cart_details">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="potro_font">অর্ডার ইনফরমেশন</h5>
                        </div>
                        <div class="card-body cartlist  table-responsive">
                            <table class="cart_table table table-bordered table-striped text-center mb-0">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="4" class="text-end px-4">Net Total</th>
                                        <td><span id="net_total">৳{{$subtotal}}</span></td>
                                    </tr>
                                    <tr>
                                        <th colspan="4" class="text-end px-4">Shipping Cost</th>
                                        <td>
                                            <span id="cart_shipping_cost">৳{{$shipping}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colspan="4" class="text-end px-4">Grand Total</th>
                                        <td>
