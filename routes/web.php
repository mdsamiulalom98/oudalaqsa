...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('products-all', [FrontendController::class, 'allproducts'])->name('allproducts');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::get('bulk-courier', [OrderController::class,'bulk_courier'])->name('admin.bulk_courier');
